...
export declare type RestEndpointMethodTypes = {
    actions: {
        ...
        createOrUpdateSecretForRepo: {
            parameters: RequestParameters & Omit<Endpoints["PUT /repos/:owner/:repo/actions/secrets/:name"]["parameters"], "baseUrl" | "headers" | "mediaType">;
        ...
        deleteSecretFromRepo: {
            parameters: RequestParameters & Omit<Endpoints["DELETE /repos/:owner/:repo/actions/secrets/:name"]["parameters"], "baseUrl" | "headers" | "mediaType">;
        ...
        getSecret: {
            parameters: RequestParameters & Omit<Endpoints["GET /repos/:owner/:repo/actions/secrets/:name"]["parameters"], "baseUrl" | "headers" | "mediaType">;
